...
# --- Config ---
OBS_PATH = Path("datasets/20250630_final_observations-sorted_V7_training.csv")
ADMISSION_PATH = Path("datasets/Admission summary all specialties.xlsx")
OUTPUT_PATH = Path("datasets/final_observations_with_targets.csv")
