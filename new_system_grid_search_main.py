...
replaces, see the old results/main/main_grid_search.py for the capped version).

Grid: α 0.1→1.0 (×10) × β 0.0→4.5 (×10) × γ 0.1→1.0 (×10) = 1,000 combos.

Outputs → results/new_system/main/{patient level, row-level}/grid_search/
"""
...
OUT_DIR     = REPO / "results" / "new_system" / "main"
