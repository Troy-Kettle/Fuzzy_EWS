...
DATA_PATH = REPO_ROOT / "datasets" / "20250630_final_observations-sorted_V7_training.csv"
SIGMOID_DIR = REPO_ROOT / "membership_functions" / "sigmoid"
OUTPUT_DIR = REPO_ROOT / "spam" / "results" / "grid_search_results"
...
def _defuzz_centroid(concern: Dict[str, float]) -> float:
    MIN_FIRING = 0.05       # keep in sync with streamlit_app.defuzz_vital_centroid
